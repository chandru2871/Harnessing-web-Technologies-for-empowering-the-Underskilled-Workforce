...
const uploadResumeToCloudinary = async (resume) => {
...
export const postApplication = catchAsyncErrors(async (req, res, next) => {
  ...
  let resumeData = null;
  // Upload resume to Cloudinary and get the resume data
  if (resume) {
    resumeData = await uploadResumeToCloudinary(resume);
    if (!resumeData) {
  ...
  const applicationData = {
    ...
    applicantID,
    employerID,
    resume: resumeData, // Include resume details
  };
